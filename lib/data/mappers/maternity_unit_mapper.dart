...
class MaternityUnitMapper {
  ...
  static MaternityUnit toDomain(MaternityUnitDto dto) {
    return MaternityUnit(
      ...
      placeCleanliness: dto.placeCleanliness,
      placeFood: dto.placeFood,
      placePrivacyDignityWellbeing: dto.placePrivacyDignityWellbeing,
      placeConditionAppearance: dto.placeConditionAppearance,
      placeSyncedAt: dto.placeSyncedAtMillis != null
          ? DateTime.fromMillisecondsSinceEpoch(dto.placeSyncedAtMillis!)
          : null,
  ...
  static MaternityUnitDto toDto(MaternityUnit entity) {
    return MaternityUnitDto(
      ...
      placeCleanliness: entity.placeCleanliness,
      placeFood: entity.placeFood,
      placePrivacyDignityWellbeing: entity.placePrivacyDignityWellbeing,
      placeConditionAppearance: entity.placeConditionAppearance,
      placeSyncedAtMillis: entity.placeSyncedAt?.millisecondsSinceEpoch,
