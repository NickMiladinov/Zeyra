...
/// 
/// This file imports and runs ALL kick counter tests (173 tests total).
...
void main() {
  group('[KickCounter] All Tests (173 tests)', () {
    // -------------------------------------------------------------------------
    ...
    group('6. Data Access Objects (15 tests)', () {
      dao_tests.main();
    });
    ...
    group('8. Performance Tests (13 tests)', () {
