/// Hospital Chooser Feature - Unit Tests Runner
///
/// This file runs all unit tests (excludes integration/performance tests).
/// Click the ▶️ Run button next to main() to run unit tests for this feature.
///
/// Includes:
/// - Domain entity tests
...
void main() {
  group('[HospitalChooser] Unit Tests', () {
    // -------------------------------------------------------------------------
    // Domain Layer Tests
    // -------------------------------------------------------------------------
